...
\imageFigure{../figures/phy456-qmII/qmTwoL3fig1}{Pictorial illustration of ket projections.}{fig:qmTwoL3:1}{0.2}
...
\end{equation}
%
An interpretation is that ``small errors'' in \(\ket{\psi}\) do not lead to large errors in \(E[\psi]\).
\imageFigure{../figures/phy456-qmII/qmTwoL3fig2}{Illustration of variation of energy with variation of Hamiltonian.}{fig:qmTwoL3:2}{0.2}
%\cref{fig:qmTwoL3:2}
...
Should we attempt a 2nd order rejection of the form
%
...
\end{equation}
%
But sometimes, even if you do not know the ground state \(\ket{\psi_0}\), can choose trial kets \(\ket{\psi'''}\) such that \(\braket{\psi_0}{\psi'''} = 0\).  In that case is it true that
...
\end{equation}
%
Somewhat remarkably, this is often possible.  We talked last time about the Hydrogen atom.  In that case, you can guess that the excited state is in the \(2s\) orbital and is therefore orthogonal to the \(1s\) orbital.

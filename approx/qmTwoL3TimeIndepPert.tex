...
\imageFigure{../figures/phy456-qmII/qmTwoL3fig3}{Example of small perturbation from known Hamiltonian.}{fig:qmTwoL3TimeIndepPert:3}{0.2}
...
\end{equation}
%
which is the problem that we already know.  However, for \(\lambda \rightarrow 1\) we have
%

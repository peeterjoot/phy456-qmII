...
\end{equation}
%
and a perturbative series representation for the probability coefficients
%
...
&\quad -
\lr{
   {E_s}^{(0)} + \lambda {E_s}^{(1)} + \lambda^2 {E_s}^{(2)} + \cdots
}
\, \times \\ &\quad
\lr{
   \ket{{\psi_s}^{(0)}}
...
\end{equation}
%
Summarizing what we learn from our \(\ket{B} = 0\) conditions we have
%
...
\end{equation}
%
however, to put some mathematical rigour into making a statement of such smallness takes a lot of work.  We are referred to \citep{messiah1999quantum}.  Incidentally, these are loosely referred to as the first and second testaments, because of the author's name, and the fact that they came as two volumes historically.

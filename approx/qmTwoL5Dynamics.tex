...
\end{equation}
%
and most of our operators \(X, P, \cdots\) are time independent, but our kets evolve with time
%
...
\end{equation}
%
Here \(O_s\) is the operator in the Schr\"{o}dinger picture, and is non time dependent.

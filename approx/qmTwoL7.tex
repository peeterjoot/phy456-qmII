...
\end{equation}
%
and hope for convergence, or at least something that at least has well defined asymptotic behaviour.  We have
%
...
\imageFigure{../figures/phy456-qmII/qmTwoL7fig1}{Perturbation around energy level s.}{fig:qmTwoL7:1}{0.2}
...
\imageFigure{../figures/phy456-qmII/qmTwoL7fig2}{Slow nucleus passing an atom.}{fig:qmTwoL7:2}{0.2}
We have
%
...
\imageFigure{../figures/phy456-qmII/qmTwoL7fig3}{Fields for nucleus atom example.}{fig:qmTwoL7:3}{0.2}
%FIXME: think through.
}
...
\imageFigure{../figures/phy456-qmII/qmTwoL7fig4}{Atom interacting with an EM pulse.}{fig:qmTwoL7:4}{0.2}
%

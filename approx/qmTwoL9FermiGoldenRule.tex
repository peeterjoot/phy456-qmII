...
%
%
\label{chap:qmTwoL9FermiGoldenRule}
...
\end{equation}
%
\paragraph{Example: Electric field potential.}
%\label{l9:ex1}
...
\end{equation}
%
\pdfTexFigure{../figures/phy456-qmII/qmTwoL9fig6.pdf_tex}{\(\omega_{mi}\) illustrated.}{fig:qmTwoL9FermiGoldenRule:6}{0.2}
...
\pdfTexFigure{../figures/phy456-qmII/qmTwoL9fig7.pdf_tex}{FIXME: qmTwoL9fig7.}{fig:qmTwoL9FermiGoldenRule:7}{0.2}
%

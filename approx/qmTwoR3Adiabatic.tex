...
\end{equation}
and for the RHS
\begin{equation}\label{eqn:qmTwoR3Adiabatic:670b}
\cancel{
   \bra{\hat{\psi}_\alpha(t)}
...
\end{equation}
%
Without the implied \(\lambda\) perturbation of \(\ket{\hat{\psi}_\alpha(t)}\) we can from \eqnref{eqn:qmTwoR3:470} write the \textunderline{exact} generalization of \eqnref{eqn:qmTwoR3:550} as
%

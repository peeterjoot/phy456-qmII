...
%
Perturbed the Hamiltonian as follows
...
To first order the perturbed base state is
%{(1)} = {(1)}
...
\imageFigure{../figures/phy456-qmII/qmTwoR3fig2}{Energy level splitting.}{fig:qmTwoR3Stark:qmTwoR3fig2}{0.2}
%
Observe the embedded Pauli matrix (I missed the point of that?)
%

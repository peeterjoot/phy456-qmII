...
&= \sum_{n \ne s}
\Biglr{ 
   \braket{n}{m'} - \delta_{nm} i ( \omega_{sn}(0) - i\braket{s}{s'} + i\braket{n}{n'})
}
\braket{s}{n'} \\
&\qquad
-\delta_{nm} \Biglr{ \braket{s'}{n'} +\braket{s}{n''} }
\\
&= - i ( \omega_{sm}(0) - i\braket{s}{s'} + i\braket{m}{m'}) \braket{s}{m'}
- \Biglr{ \braket{s'}{m'} +\braket{s}{m''} } \\
&\quad
+

...
\begin{dmath}\label{eqn:phy456ps1:500}
\bra{n} X^4 \ket{n}
=
...
%
\makeoproblem{Position expectation, spinless hydrogen.}
%{Expectation values for position operators for spinless hydrogen}
{pr:phy456ps1:2}{2011 ps1/p2}{
...
\bra{\Phi_{nlm}} &X \ket{\Phi_{nlm}} \\
&\sim
\int r^2 dr \Abs{F_{nl}\left( \frac{2 r}{ n a_0} \right)}^2 r \times
\int \sin\theta d\theta d\phi
...
%
\makeoproblem{Angular momentum operator.}{pr:phy456ps1:3}{2011 ps1/p3}{

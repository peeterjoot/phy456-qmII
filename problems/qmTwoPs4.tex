...
Attempting that calculation with \href{https://github.com/peeterjoot/physicsplay/blob/796c8e3739ae1a9ca26270a0e91384afba45661d/notes/phy456/problem\%20set\%204,\%20problem\%202.nb}{Mathematica} however, is deceiving, since Mathematica reports these all as zero after FullSimplify.  It appears, that as used, it does not allow for \(m = n\) and \(m = n \pm 1\) constraints properly where the denominators of the unsimplified integrals go zero, and more careful evaluation is required.
%

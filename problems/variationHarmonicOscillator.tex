...
%\date{Oct 3, 2011}
%
\makeproblem{SHO ground state energy, variational method.}{problem:variationHarmonicOscillator:1}{
Problem 3 of \S 24.4 in the text \citep{desai2009quantum} asks to use the variational method to find the ground state energy of a one dimensional harmonic oscillator Hamiltonian.
} % problem

\makeanswer{problem:variationHarmonicOscillator:1}{
\paragraph{Recap.  Variational method to find the ground state energy.}
%
...
%
\paragraph{Recap.  The variational method.}
%
...
%
\paragraph{The Harmonic oscillator variational problem.}
%
...
2 \int_{0}^\infty dx
e^{- 2 \beta x} &
\lr{ -\frac{\Hbar^2 \beta^2}{2m} + \inv{2} m \omega^2 x^2 } \\
&=
...
%
\paragraph{Is our trial function representable?}
%
...
\braket{\psi_n}{\psi_\perp} \\
&\quad + c_n c_\perp^\conj E_n \braket{\psi_\perp}{\psi_n}
+ \Abs{c_\perp}^2
...
%
\paragraph{Calculating the Fourier terms.}
%
...
%
\paragraph{Correcting, treating the origin this way.}
%

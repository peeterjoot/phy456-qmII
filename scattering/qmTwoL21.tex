...
%
We will focus on point particle elastic collisions (no energy lost in the collision).  With particles of mass \(m_1\) and \(m_2\) let the total mass be
%
\begin{equation}\label{eqn:qmTwoL21:10}
M = m_1 + m_2,
\end{equation}
with a corresponding reduced mass of
%
...
\imageFigure{../figures/phy456-qmII/qmTwoL21Fig3}{Wave packet for a particle wavefunction \(\Real(\psi(x,0))\).}{fig:qmTwoL21:qmTwoL21Fig3}{0.2}
...
Suppose that we have, as depicted in 
%\cref{fig:qmTwoL21:qmTwoL21Fig4},
\cref{fig:qmTwoL8:gaussianWavePacket},
...
\psi(x, 0) = (\pi \Delta^2)^{1/4} e^{i k_0 x} e^{- x^2/2 \Delta^2}.
\end{equation}
%
...
-\frac{\Hbar^2}{2 \mu} \evalbar{\frac{d\phi_k(x)}{dx}}{x_3} &= - V(x_3) \psi_k(x_3) + \frac{\Hbar^2 k^2}{2\mu} \psi_k(x_3).
\end{aligned}
\end{equation}
%

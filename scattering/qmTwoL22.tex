...
\imageFigure{../figures/phy456-qmII/qmTwoL22fig1}{A bounded positive potential.}{fig:qmTwoL22:qmTwoL22fig1}{0.2}
%
...
\end{equation}
%
We will integrate these equations back to \(x_1\).
...
\imageFigure{../figures/phy456-qmII/qmTwoL22fig3}{Wave packet in free space and with positive potential.}{fig:qmTwoL22:qmTwoL22fig3}{0.2}
...
\end{equation}
%
where as illustrated in \cref{fig:qmTwoL22:qmTwoL22fig4}, we have
\imageFigure{../figures/phy456-qmII/qmTwoL22fig4}{Reflection and transmission of wave packet.}{fig:qmTwoL22:qmTwoL22fig4}{0.2}
%
...
0 & \quad \mbox{for \(x > x_2, x > x_1\)}.
\end{array}
\right.
\end{equation}
Note that we didn't prove the \(x > x_1\) case.
%
For \(t = t_{\text{final}}\)
%
...
\end{equation}
%
If we have a sufficiently localized packet, we can form a first order approximation around the peak of \(\beta_k\) (FIXME: or is this a sufficiently localized response to the potential on reflection?)
%

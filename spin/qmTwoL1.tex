...
We loosely describe a Hilbert space (finite or infinite dimensional) as the set of states that describe the system.  There were some additional details (completeness, normalizable, \(L2\) integrable, ...) not really covered in the physics curriculum, but available in mathematical descriptions.

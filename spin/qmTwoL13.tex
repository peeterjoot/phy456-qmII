...
\end{equation}
%
The spin \(s\) is fixed once we decide that we are talking about a specific type of particle.
...
Let us start talking about the simplest case.  This includes electrons, all leptons (integer spin particles like photons and the weakly interacting W and Z bosons), and quarks.  That is
%
...
\end{equation}
%
Now introduce additional shorthand
%
...
\end{equation}
%
The matrix representations of the spin operators was
...
\end{equation}
%
One can easily work out from the commutation relationships that the \( x\) and \(y\) oriented spin operators are
%
...
\end{equation}
%
Our next topic will be adding \(\BL\) into the mix.
%on Wednesday.

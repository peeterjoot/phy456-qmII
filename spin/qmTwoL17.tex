...
\end{equation}
%
but will often omit the \(; j_1 j_2\) portion.  Here's a tabulation of the first two, and the last value in the \( j = j_1 + j_2 - k \), progression with \( k = 0, \cdots 2 j_2 \)
%
\begin{equation}\label{eqn:qmTwoL17:560}
\begin{array}{| l | l | l |}
\hline
 j = j_1 + j_2                      & j = j_1 + j_2 -1                     & j = j_1 - j_2                      \\
\hline
\hline
  \ket{j_1 + j_2, j_1 + j_2}        &                                      &                                    \\
\hline

...
%
It was just made up.  We are creating a shorthand to say that we have a number of different basis states for each of the groupings.  
%\textunderline{I Need an example!}
...
\end{equation}
%
but will often omit the \(; j_1 j_2\) portion.  Tab. \ref{tab:qmTwoL17:10} tabulates the \( j = j_1 + j_2 - k \) progression of kets with \( k = 0, \cdots 2 j_2 \)
%
% https://tex.stackexchange.com/a/27105/15
%%%\begin{table}
%%%\resizebox{\textwidth}{!}{%
%%%\begin{tabular}{|c|c|c|c|}
%%%\hline
%%%\( j = j_1 + j_2 \)                     & \( j = j_1 + j_2 -1 \)                     &\(\hdots\)& \( j = j_1 - j_2 \)                       \\
%%%\hline
%%%\hline
%%%\(  \ket{j_1 + j_2, j_1 + j_2} \)       &                                            &&                                           \\
%%%\hline
%%%\(  \ket{j_1 + j_2, j_1 + j_2 - 1} \)   & \( \ket{j_1 + j_2 - 1, j_1 + j_2 - 1} \)   &&                                           \\
%%%\hline                                  &                                            && \( \ket{j_1 + j_2 - 1, j_1 + j_2 - 2} \)  \\
%%%\hline
...
%\end{tablelabelbox}
%
\begin{tablelabelbox}[tabularx=c|c|c|c]{Clebsch-Gordan kets.}{label=tab:qmTwoL17:10}
   \eqssmaller{ j = j_1 + j_2 }                     & \eqssmaller{ j = j_1 + j_2 -1 }                     &\eqssmaller{\hdots}& \eqssmaller{ j = j_1 - j_2 }                       \\ \hline\hline
   \eqssmaller{  \ket{j_1 + j_2, j_1 + j_2} }       &                                                    &&                                                   \\ \hline
   \eqssmaller{  \ket{j_1 + j_2, j_1 + j_2 - 1} }   & \eqssmaller{ \ket{j_1 + j_2 - 1, j_1 + j_2 - 1} }   &&                                                   \\ \hline
                                                   &                                                    && \eqssmaller{ \ket{j_1 + j_2 - 1, j_1 + j_2 - 2} }  \\ \hline
   \eqssmaller{ \vdots }                            &                                                    && \eqssmaller{ \ket{j_1 - j_2, j_1 - j_2} }          \\ \hline
   \eqssmaller{ \vdots }                            & \eqssmaller{ \vdots }                               && \eqssmaller{ \vdots }                              \\ \hline
   \eqssmaller{ \vdots }                            &                                                    && \eqssmaller{ \ket{j_1 - j_2, -(j_1 - j_2)} }       \\ \hline
                                                   &                                                    &&                                                   \\ \hline
   \eqssmaller{ \ket{j_1 + j_2, -(j_1 + j_2 - 1)} } & \eqssmaller{ \ket{j_1 + j_2 -1, -(j_1 + j_2 - 1)} } &&                                                   \\ \hline
   \eqssmaller{ \ket{j_1 + j_2, -(j_1 + j_2)} }     &                                                    &&                                                   \\ \hline

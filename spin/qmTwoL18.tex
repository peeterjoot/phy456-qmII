...
%
\begin{dmath}\label{eqn:qmTwoL18:110}
\ket{j_1 + j_2 - 1, j_1 + j_2 -1}
=
\left(\frac{j_2}{j_1 + j_2}\right)^{1/2}
\ket{j_1 j_1} \otimes \ket{j_2 (j_2-1)}
...
%
%ATABXX
\begin{tablelabelbox}[tabularx={c|c}]{Total angular momentum states for electron.}{label=eqn:qmTwoL18:350}
  \eqnormal{j = l + \inv{2}} 			                & \eqnormal{j = l - \inv{2}}                    \\ \hline\hline
  \eqnormal{\ket{l + \inv{2}, l + \inv{2}}}         &                                               \\ \hline
  \eqnormal{\ket{l + \inv{2}, l + \inv{2} - 1}}     & \eqnormal{\ket{l - \inv{2}, l - \inv{2}}}     \\ \hline
                                                    & \eqnormal{\ket{l - \inv{2}, -(l - \inv{2}}}   \\ \hline
  \eqnormal{\ket{l + \inv{2}, -(l + \inv{2})}}      &                                               \\ \hline
\end{tablelabelbox}
%

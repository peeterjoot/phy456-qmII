...
Rotating with \(U[M]\) as in \cref{fig:qmTwoL19:qmTwoL19fig1} to the new position
...
\end{equation}
%
and we will call these the components of (Cartesian) a second rank tensor operator.  Suppose that we have an operator \(S\) that transforms as
%
\begin{equation}\label{eqn:qmTwoL19:210}
U[M] S U^\dagger[M] = S.
\end{equation}
%
We will call \(S\) a scalar operator.
%
\section{A problem.}
%
